...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Donec pede justo, fringilla vel, aliquet nec, vulputate eget,
			arcu. Aenean imperdiet. Pellentesque habitant morbi tristique
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Phasellus consectetuer vestibulum elit. Sed cursus turpis vitae
			tortor.</p>
		<p class="meta">
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Sed fringilla mauris sit amet nibh. Fusce vel dui. Lorem ipsum
			dolor sit amet, consectetuer adipiscing elit. Quisque ut nisi.</p>
		<p class="meta">
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet
			feugiat, pede. Donec sodales sagittis magna. Proin faucibus arcu quis
			ante.</p>
		<p class="meta">
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Duis leo. Nullam accumsan lorem in dui. In consectetuer turpis
			ut velit. Fusce vulputate eleifend sapien. Donec sodales sagittis
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Vestibulum fringilla pede sit amet augue. Phasellus volutpat,
			metus eget egestas mollis, lacus lacus blandit dui, id egestas quam
			mauris ut lacus. Sed aliquam ultrices mauris.</p>
		<p class="meta">
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Praesent metus tellus, elementum eu, semper a, adipiscing nec,
			purus. Etiam imperdiet imperdiet orci. Nunc nonummy metus. Morbi
...
<div class="media-object comment-item">
	...
	<div class="media-object-section">
		...
		<p>Quisque ut nisi. In hac habitasse platea dictumst. Pellentesque
			posuere. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id,
			lorem. Vestibulum fringilla pede sit amet augue. Sed consequat, leo
			eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi
			a libero.</p>
		<p class="meta">
